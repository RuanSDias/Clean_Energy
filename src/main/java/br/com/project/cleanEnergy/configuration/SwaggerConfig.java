package br.com.project.cleanEnergy.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.project.cleanEnergy.controllers"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Clean Energy").description("Projeto API Spring - Clean Energy")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/RuanSDias/Clean_Energy")
